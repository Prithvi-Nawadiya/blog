...
<div class="hero-section fade-in-up" style="padding: 60px 0 40px;">
    <h1 class="hero-title">About HireOn</h1>
    ...
    <div class="mx-auto" style="max-width: 1100px;">
        <div class="text-center mb-4">
            ...
            <p class="text-muted mx-auto" style="max-width: 880px; line-height: 1.7;">
                HireOn is a modern career and update portal designed to help students, freshers, and job seekers stay informed with the latest opportunities. From government jobs and internships to admit cards and exam results, HireOn brings all important updates together in one clean and easy-to-access platform.
            </p>
            <p class="text-muted mx-auto" style="max-width: 880px; line-height: 1.7;">
