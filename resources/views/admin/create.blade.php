        ...
        <div class="glass-panel p-4 p-md-5 border-0 shadow-sm" style="border-radius: 16px;">
            <form id="createForm" action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="contentEditor" name="content" rows="12" class="form-control shadow-sm @error('content') is-invalid @enderror" placeholder="Write your thoughts here... Let your creativity flow." style="line-height: 1.7; font-size: 1rem; padding: 1.5rem;">{{ old('content') }}</textarea>
                ...
                <div class="mb-2 p-4 rounded-3 text-center" style="background: rgba(255,255,255,0.02); border: 2px dashed rgba(255,255,255,0.1); transition: 0.2s;" onmouseover="this.style.background='rgba(255,255,255,0.03)'" onmouseout="this.style.background='rgba(255,255,255,0.02)'">
                    ...
                    <label class="form-label fw-bold text-white d-block mb-1 fs-5">Upload Cover Image</label>
